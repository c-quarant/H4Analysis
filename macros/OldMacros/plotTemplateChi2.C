...
void plotChi2(std::string FileIn, std::string detector, Float_t bound, std::string MCP)
{
	...
	c0->SaveAs((pathToOutput+"fitTimeDist/TemplateChi2/Chi2_Cut_"+detector+"_"+RunStats+".png").c_str());
	c0->SaveAs((pathToOutput+"fitTimeDist/TemplateChi2/Chi2_Cut_"+detector+"_"+RunStats+".pdf").c_str());
