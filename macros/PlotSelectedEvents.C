...
void PlotSelectedEvents(std::string NtupleFile, std::string detector, int bound, std::string MCP)
{
	...
	AmplitudeHist(h4, detector, "", pathToOutput + "SelectedEvents/", "NoCut_"+RunStats, &AmpMean, &AmpSigma, "AllEvents");
	cout << "ciao" << endl;
	...
	AmplitudeHist(h4, detector, Selection, pathToOutput + "SelectedEvents/", "PosCut_AmpMCPCut_"+RunStats, &AmpMean, &AmpSigma, "C");
	...
	AmplitudeHist2(h4, detector, Selection, pathToOutput + "SelectedEvents/", "PosCut_AmpMCPCut_TimeMCPcut"+RunStats, &AmpMean, &AmpSigma, "D");
	...
	AmplitudeHist(h4, detector, Selection, pathToOutput + "SelectedEvents/", "PosCut_AmpMCPCut_TimeMCPcut_AmpDetCut"+RunStats, &AmpMean, &AmpSigma, "SelectedEvents");	
